      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
          {services.map((service) => (
            <article
              key={service.title}
              className="reveal group rounded-2xl border border-white/10 bg-white/[0.035] p-6 shadow-xl shadow-black/15 backdrop-blur transition hover:-translate-y-1.5 hover:border-[#d7b46a]/45 hover:bg-white/[0.055] hover:shadow-[0_20px_80px_rgba(215,180,106,0.09)]"
            >
