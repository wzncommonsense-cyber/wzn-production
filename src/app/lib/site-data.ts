...
export const portfolio = [
  ...
  {
    title: "Anime Intro",
    category: "Video / animatie",
    description:
      "Visuele intro met donkere anime-stijl, motion workflow en promotionele energie.",
    image: "/assets/anime-intro.png",
    imageAlt: "Anime intro montage voorbeeld",
  },
  {
    title: "Website concepten",
    category: "Website / dashboard concept",
    description:
      "Interfaceconcepten voor dashboards, webshops en AI-software met duidelijke UX.",
    image: "/assets/ai-dashboard-demo.png",
    imageAlt: "Website en dashboard concept voorbeeld",
  },
];
...
export const processSteps = [
  {
    title: "Idee bespreken",
    description:
      "We starten met jouw idee, doelgroep, doelen en wat het project concreet moet opleveren.",
  },
  {
    title: "Plan maken",
    description:
      "Ik vertaal het idee naar een duidelijke aanpak met scope, prioriteiten en verwachte oplevering.",
  },
  {
  ...
  },
  {
    title: "Feedbackronde",
    description:
      "We lopen het resultaat samen na en verbeteren wat scherper, duidelijker of sterker kan.",
  },
  {
    title: "Oplevering",
    description:
